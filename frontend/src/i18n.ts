...
const ko: Record<string, string> = {
  ...
  agentGoalsTitle: '인트로 목표',
  agentGoalPaperUsd: '페이퍼 기준 ($)',
  agentGoalDailyPct: '일일 목표 (%)',
  agentGoalLossLimitPct: '일일 손실 한도 (%)',
  agentGoalLiveEquity: '실계좌 에퀴티',
  agentGoalResetToInitial: '초기 자본과 동기화',
  agentGoalsHelpPaper:
    '채팅 맨 위 인사말에 쓰는 금액입니다. 브로커 잔고를 바꾸지는 않습니다.',
  agentGoalsHelpLive:
    '금액은 Alpaca 에퀴티입니다. 일일 목표 %만 바꿀 수 있습니다.',
  powered: '기반',
  analyzing: '분석 중...',
...
const en: Record<string, string> = {
  ...
  agentGoalsTitle: 'Intro targets',
  agentGoalPaperUsd: 'Paper notional ($)',
  agentGoalDailyPct: 'Daily target (%)',
  agentGoalLossLimitPct: 'Daily loss limit (%)',
  agentGoalLiveEquity: 'Live equity',
  agentGoalResetToInitial: 'Sync to initial capital',
  agentGoalsHelpPaper:
    'Headline amount in the first chat message. Does not change your broker balance.',
  agentGoalsHelpLive:
    'Amount is your Alpaca equity. Edit the daily % goal for the agent.',
  powered: 'Powered',
  analyzing: 'Analyzing…',
